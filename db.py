...
class Categories(models.Model):
    ...
    subsubcategory = models.TextField(blank=True, null=True)
...
class ImportDataQuestion(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    title = models.CharField(max_length=255)
    user = models.ForeignKey('ImportDataUser', models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'import_data_question'


class ImportDataQuestionTags(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    question = models.ForeignKey(ImportDataQuestion, models.DO_NOTHING)
    tag = models.ForeignKey('ImportDataTag', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'import_data_question_tags'


class ImportDataTag(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    title = models.CharField(max_length=255)

    class Meta:
        managed = False
        db_table = 'import_data_tag'


class ImportDataUser(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    title = models.CharField(max_length=255)

    class Meta:
        managed = False
        db_table = 'import_data_user'
...
class Products(models.Model):
    ...
    afbeelding = models.TextField(blank=True, null=True)
